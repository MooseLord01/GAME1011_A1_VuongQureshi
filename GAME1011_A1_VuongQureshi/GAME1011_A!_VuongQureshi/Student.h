...
protected:
	...
	// Arrays
	std::string listOfCollegeNames[10] = {
		"United College of Dat",
		"#1 College of Mustafa",
		"Absolute Greatest College of Wallace, which has the bestest teacher (Wally)",
		"Humber College", "Seneca College", "Centennial College", "George Brown College",
		"Ryerson(wait that's not a college) University", "College of Godstafa and DietyDat" ,
		"Totally Real College Not a Scam plz Give Money" };
